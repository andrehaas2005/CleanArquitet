...
class LoginControllerFactoryTests: XCTestCase {
    ...
    func test_login_composite_if_correct_validations() {
...
extension LoginControllerFactoryTests {
    func makeSut(file: StaticString = #file, line: UInt = #line) -> (sut: LoginViewController, authentication: AuthenticationSpy) {
